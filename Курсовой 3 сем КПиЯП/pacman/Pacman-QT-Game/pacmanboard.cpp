...
{
return QRect(0,0,450,480); // Установка размера карты
}
...
// Алгоритм передвижения пакмана по карте
...
// алгоритм прорисовки пути пакмана
